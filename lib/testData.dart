...
class TestData{
  ...
  Object getRbd(){
    ...
    print("rbd.tostring:"+raceBracketDetail.places.toString());
    var hdByRound=raceBracketDetail.getHeatDetailByRound();
    print("hd 1 rounds:"+hdByRound.toString());
    print("hd 2 rounds:"+hdByRound.keys.toList().toString());
    return rbd;
  }
}